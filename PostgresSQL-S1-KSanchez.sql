...
--CREATE DATABASE KarinaSanchezS1;
...
CREATE TABLE empleado (
  ...
  CONSTRAINT FK_empleado_oficina FOREIGN KEY(codigoOficina) REFERENCES oficina(codigoOficina),
  CONSTRAINT FK_empleado_empleado FOREIGN KEY(codigoJefe) REFERENCES empleado(codigoEmpleado)
...
CREATE TABLE cliente (
  ...
  CONSTRAINT FK_cliente_empleado FOREIGN KEY(codigoEmpleado_repVentas) REFERENCES empleado(codigoEmpleado)
...
CREATE TABLE producto (
  ...
  constraint FK_PRODUCTO_GAMA foreign key(gama) references gamaProducto(gama)
...
CREATE TABLE detallePedido (
  ...
  numeroLinea SMALLINT NOT NULL,
   CONSTRAINT FK_detallePedido_pedido FOREIGN KEY(codigoPedido) REFERENCES pedido(codigoPedido),
    CONSTRAINT FK_detallePedido_cliente FOREIGN KEY(codigoProducto) REFERENCES producto(codigoProducto)
...
CREATE TABLE pago (
  ...
  CONSTRAINT PK_pago PRIMARY KEY(codigoTransaccion),
  CONSTRAINT FK_pago_cliente FOREIGN KEY(codigoCliente) REFERENCES cliente(codigoCliente)
